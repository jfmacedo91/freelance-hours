...
<div @class([ "flex items-center justify-center rounded-full w-[40px] h-[40px]" ,
  "bg-[#FEF3C7] text-[#F59E0B]"=> $position == 0,
  "bg-[#F1F5F9] text-[#94A3B8]" => $position == 1,
  "bg-[#FFEDD5] text-[#B45309]" => $position == 2,
  "bg-[#F1F5F9]" => $position > 2 && $status == null,
  "bg-[#C0F7B4]" => $position > 2 && $status == 'up',
  "bg-[#FECDD3]" => $position > 2 && $status == 'down',
])>
